...
func load_4(in []byte) uint64 {
	return binary.LittleEndian.Uint64(in[:4])
}

func x25519_sc_reduce(s []byte) [32]byte {

	var (
		s0 = uint64(2097151 & load_3(s))
		s1 = uint64(2097151 & (load_4(s[2:]) >> 5))
		s2 = uint64(2097151 & (load_3(s[5:]) >> 2))
		s3 = uint64(2097151 & (load_4(s[7:]) >> 7))
		s4 = uint64(2097151 & (load_4(s[10:]) >> 4))
		s5 = uint64(2097151 & (load_3(s[13:]) >> 1))
		s6 = uint64(2097151 & (load_4(s[15:]) >> 6))
		s7 = uint64(2097151 & (load_3(s[18:]) >> 3))
		s8 = uint64(2097151 & load_3(s[21:]))
		s9 = uint64(2097151 & (load_4(s[23:]) >> 5))
		s10 = uint64(2097151 & (load_3(s[26:]) >> 2))
		s11 = uint64(2097151 & (load_4(s[28:]) >> 7))
		s12 = uint64(2097151 & (load_4(s[31:]) >> 4))
		s13 = uint64(2097151 & (load_3(s[34:]) >> 1))
		s14 = uint64(2097151 & (load_4(s[36:]) >> 6))
		s15 = uint64(2097151 & (load_3(s[39:]) >> 3))
		s16 = uint64(2097151 & load_3(s[42:]))
		s17 = uint64(2097151 & (load_4(s[44:]) >> 5))
		s18 = uint64(2097151 & (load_3(s[47:]) >> 2))
		s19 = uint64(2097151 & (load_4(s[49:]) >> 7))
		s20 = uint64(2097151 & (load_4(s[52:]) >> 4))
		s21 = uint64(2097151 & (load_3(s[55:]) >> 1))
		s22 = uint64(2097151 & (load_4(s[57:]) >> 6))
		s23 = uint64((load_4(s[60:]) >> 3))
		carry0 = uint64(0)
		carry1 = uint64(0)
		carry2 = uint64(0)
		carry3 = uint64(0)
